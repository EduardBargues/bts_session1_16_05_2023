...
<!-- TODO: create repository with a 'hello world' asp.net core api so students can clone and try to run it. -->
...
[Sign In/Up to your AWS account](https://aws.amazon.com/)
[Explore free products in AWS](https://aws.amazon.com/free)

<!-- TODO: Slide to create an AWS account with MFA enabled. -->

---

<!-- TODO: Create slide about how to created apigw+lambda in AWS -->

# **Our first api in AWS**

[Apigateway](https://docs.aws.amazon.com/apigateway/index.html) + Mock integration

---

# **How do urls work?**

![bg w:100%](images/url_example.png)

---

# **Homework: Apigateway + Lambda**

<!-- TODO: image of apigateway and lambda -->
